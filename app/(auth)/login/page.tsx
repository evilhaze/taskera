          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col gap-2">
              <button
                type="button"
                disabled
                title="Вход через Google скоро будет доступен"
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-[var(--asana-border)] bg-[var(--asana-bg-input)] py-2.5 text-sm font-medium text-[var(--asana-text-secondary)] opacity-60 cursor-not-allowed"
              >
                ...
                <Lock className="h-4 w-4 shrink-0 text-[var(--asana-text-placeholder)]" aria-hidden />
                <span className="rounded-full bg-neutral-200 px-2 py-0.5 text-xs font-medium text-neutral-600 dark:bg-neutral-600 dark:text-neutral-300">
                  Скоро
                </span>
              </button>
              <button
                type="button"
                disabled
                title="Вход через GitHub скоро будет доступен"
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-[var(--asana-border)] bg-[var(--asana-bg-input)] py-2.5 text-sm font-medium text-[var(--asana-text-secondary)] opacity-60 cursor-not-allowed"
              >
                ...
                <span className="flex-1 text-left">Войти через GitHub</span>
                <Lock className="h-4 w-4 shrink-0 text-[var(--asana-text-placeholder)]" aria-hidden />
                <span className="rounded-full bg-neutral-200 px-2 py-0.5 text-xs font-medium text-neutral-600 dark:bg-neutral-600 dark:text-neutral-300">
                  Скоро
                </span>
