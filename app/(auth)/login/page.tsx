...
const OAUTH_ERRORS: Record<string, string> = {
  ...
  google_no_code: "Вход через Google отменён.",
  google_token: "Ошибка авторизации Google.",
  google_profile: "Не удалось получить профиль Google.",
  google_no_email: "Google не предоставил email.",
  github_not_configured: "Вход через GitHub не настроен.",
  github_no_code: "Вход через GitHub отменён.",
  github_token: "Ошибка авторизации GitHub.",
  github_profile: "Не удалось получить профиль GitHub.",
  github_no_email: "Укажите публичный email в настройках GitHub."
};
